...
import com.team8.locky.BaseActivity;
import com.team8.locky.R;
...
import com.team8.locky.ReservationActivity;
 ...
 */
public class MapActivity extends BaseActivity implements LocationRecyclerViewAdapter.ClickListener, MapboxMap.OnMapClickListener, PermissionsListener
{
  private static final LatLngBounds LOCKED_MAP_CAMERA_BOUNDS = new LatLngBounds.Builder()
          .include(new LatLng(4.8486259, -73.881749))
          .include(new LatLng(4.4486259, -74.281749)).build();
  private LatLng MOCK_DEVICE_LOCATION_LAT_LNG = new LatLng(4.713469, -74.006735);
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // Initialize the theme that was selected in the previous activity.
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      @Override public void onMapReady(@NonNull final MapboxMap mapboxMap) {
          ...
          public void onStyleLoaded(@NonNull Style style) {
            ...
            if (featureList != null) {
              ...
              for (int x = 0; x < featureList.size(); x++) {
                ...
                String singleLocationMaxFare = singleLocation.getStringProperty("maxFare");
                String singleLocationMinFare = singleLocation.getStringProperty("minFare");
                ...
                String fare = ""+singleLocationMinFare+" - " + singleLocationMaxFare;
  ...
  private void enableLocationComponent(@NonNull Style loadedMapStyle) {
    ...
    if (PermissionsManager.areLocationPermissionsGranted(this)) {
      ...
      // Update new Location
      Location nl = locationComponent.getLastKnownLocation();
      double lat = nl.getLatitude();
      double lon = nl.getLongitude();
      MOCK_DEVICE_LOCATION_LAT_LNG =  new LatLng(lat,lon);
  ...
  private void getFeatureCollectionFromJson() throws IOException {
    try {
      ...
      boolean bool = deviceHasInternetConnection();
      if ( bool )
      {
  ...
  private void downloadGeoJsonFromURL() {
      new DownloadTask(MapActivity.this).execute();
  }
  ...
  public void onExplanationNeeded(List<String> permissionsToExplain) {
    Toast.makeText(this, "La app necesita permisos para mostrar la información", Toast.LENGTH_LONG).show();
  }
  ...
  public void onPermissionResult(boolean granted) {
    if (granted) {
      ...
      Toast.makeText(this, "Locky no tiene permisos de acceder a tu ubicación, por favor intenta de nuevo", Toast.LENGTH_LONG).show();
      finish();
    }
  }
  ...
  public void goToReservation(View v)
  {
    ...
    if(isConnected) {
      ...
      TextView vr = findViewById(R.id.location_name_tv);


      String idR = vr.getText().toString();
      System.out.println("El id del lugar es: " + idR);
      intent.putExtra("id_place", idR);
      startActivity(intent);
    }
    else {
      Toast.makeText(this, "No tienes conexión a internet, por favor intenta de nuevo más tarde", Toast.LENGTH_LONG).show();
    }
  }
