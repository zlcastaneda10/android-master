...
open class BaseActivityLockyMenu : AppCompatActivity(), ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    private fun showMessage(isConnected: Boolean) {
        ...
        if (!isConnected) {
            ...
            mSnackBar = Snackbar.make(viewPos, messageToUser, Snackbar.LENGTH_LONG) //Assume "rootLayout" as the root layout of every activity.
